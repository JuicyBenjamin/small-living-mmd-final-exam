...
export default component$(() => {
  return (
    <article class={"py-20"}>
      <div class={"w-full grid grid-cols-[4fr_auto_1fr]"}><span class={"border-b-2 border-green-900 w-full"}></span><h2 class={"border-b-0  font-bold uppercase text-2xl px-2"}>{"data.title"}</h2><span class={"border-b-2 border-green-900 w-full"}></span></div>
      <div class={"flex justify-center pt-8 px-16 gap-12"}>
        ...
        <section>
          ...
          <p class={"max-w-[55ch] pb-4 text-center"}>
